import type { PlanResultVO, RagAnswerVO, WorkflowResultVO } from "./api";
...
export const stepNames = [
  ...
  "generate_report", "clarify", "draft_proposal", "search_documents", "read_task_board",
] as const;
...
export type ProgressEvent = TraceEvent | TokenEvent;
export type Results = { knowledge: RagAnswerVO; planning: PlanResultVO; workflow: WorkflowResultVO };
